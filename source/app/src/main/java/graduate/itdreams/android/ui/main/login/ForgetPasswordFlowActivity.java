...
import graduate.itdreams.android.databinding.ActivityForgetPasswordFlowBinding;
...
public class ForgetPasswordFlowActivity extends BaseActivity<ActivityForgetPasswordFlowBinding, ForgetPasswordFlowViewModel> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container, new RequestForgetPasswordFragment() )
                    .commit();
        }
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_forget_password_flow;
    }
